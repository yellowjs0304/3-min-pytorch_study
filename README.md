...
### [6장. 사람의 지도 없이 학습하는 오토인코더](https://yjs-program.tistory.com/163) / [코드](./06-사람의_지도_없이_학습하는_오토인코더)

정답이 없는 상태에서 특징을 추출하는 비지도학습에 대해 알아보고 대표적인 비지도학습 모델인 오토인코더를 이해하고 구현하는 방법을 익힙니다.

### [7장. 순차적인 데이터를 처리하는 RNN](https://yjs-program.tistory.com/164) / [코드](./07-순차적인_데이터를_처리하는_RNN)
### [7-1. LSTM, GRU 설명 추가](https://yjs-program.tistory.com/165)
문자열, 음성, 시계열 데이터에 높은 성능을 보이는 RNN을 활용하여 영화 리뷰 감정 분석을 해보고 간단한 기계 번역기를 만들어봅니다.

### [8장. 딥러닝을 해킹하는 적대적 공격](https://yjs-program.tistory.com/171) / [코드](./08-딥러닝을_해킹하는_적대적_공격)

딥러닝 모델을 의도적으로 헷갈리게 하는 적대적 예제에 대해 알아보고 적대적 예제를 생성하는 방법인 적대적 공격(adversarial attack)을 알아봅니다.

### [9장. 경쟁하며 학습하는 GAN](https://yjs-program.tistory.com/172) / [코드](./09-경쟁하며_학습하는_GAN)
